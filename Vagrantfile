...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "dhunnapotha-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/gctest"
  #   chef.validation_client_name = "gctest-validator"
  #   chef.validation_key_path = ".chef/gctest-validator.pem"
  # end
end
